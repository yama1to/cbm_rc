...
### 共通設定
from esn_memory_ou import Config

config = Config()
common.config  = config
common.prefix  = "data%s_esn_memory_ou" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_esn_memory_ou" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python esn_memory_ou.py " # 実行されるプログラム
