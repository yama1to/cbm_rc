...
### 共通設定
from cbmrc9a_narma_esn import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc9a_narma_esn" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc9a_narma_esn" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc9a_narma_esn.py " # 実行されるプログラム
common.columns =['dataset','seed','id','NN','Nh','alpha_i','alpha_r','alpha_b','alpha_s',"alpha0",'beta_i','beta_r','beta_b','Temp','lambda0','delay','cnt_overflow',"RMSE",'NRMSE',"NMSE"]
common.parallel= 90
common.setup()
...
def optimize():
    ...
    #opt.append("alpha_0",value=1,min=0,max=2,round=2)
