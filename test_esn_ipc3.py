...
### 共通設定
from esn_ipc3 import Config

config = Config()
common.config  = config
common.prefix  = "data%s_esn_ipc3" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_esn_ipc3" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python esn_ipc3.py " # 実行されるプログラム
common.columns=['dataset','seed','id','Nh','alpha_i','alpha_r','alpha0','beta_i','beta_r',
'lambda0',"delay","degree","set","MC"]
common.parallel= 32
common.setup()
