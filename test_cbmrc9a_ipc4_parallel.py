...
### 共通設定
from cbmrc9a_ipc4_parallel import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc9a_ipc4_parallel" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc9a_ipc4_parallel" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc9a_ipc4_parallel.py " # 実行されるプログラム
common.columns=['dataset','seed','id','NN','Nh','alpha_i','alpha_r','alpha_b','alpha_s','beta_i','beta_r','beta_b',
'Temp','lambda0',"delay","degree","parallel","MC","set",'cnt_overflow']
common.parallel= 8
common.setup()
...
#gs2()
x1,x2,target = "Nh","parallel","MC"
csv='/home/yamato/Downloads/cbm_rc/data/data20220214_152157_cbmrc9a_ipc4_parallel/data20220214_152157_cbmrc9a_ipc4_parallel_scan2d_Nh_parallel.csv'
