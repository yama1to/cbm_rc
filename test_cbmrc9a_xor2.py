...
### 共通設定
from cbmrc9a_xor2 import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc9a_xor2" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc9a_xor2" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc9a_xor2.py " # 実行されるプログラム
...
def rs1():
    ...
    df = df[['alpha_r','alpha_i','BER','cnt_overflow']] # 指定した列のみでデータフレームを構成する
