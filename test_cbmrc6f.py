...
common.prefix  = "data%s_cbmrc6f" % common.string_today() # 実験名（ファイルの接頭辞）
common.dir_path= "data%s_cbmrc6f" % common.string_today() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc6f.py " # 実行されるプログラム
