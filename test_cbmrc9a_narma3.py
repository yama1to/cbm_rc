...
### 共通設定
from cbmrc9a_narma3 import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc9a_narma3" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc9a_narma3" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc9a_narma3.py " # 実行されるプログラム
...
def optimize():
    ...
    opt.append("alpha_i",value=0.1,min=0.1,max=1,round=2)
