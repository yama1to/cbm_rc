...
### 共通設定
from cbmrc9a_narma_taisyo import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc9a_narma_taisyo" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc9a_narma_taisyo" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc9a_narma_taisyo.py " # 実行されるプログラム
