...
### 共通設定
from cbmrc9a_ipc3_taisyo import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc9a_ipc3_taisyo" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc9a_ipc3_taisyo" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc9a_ipc3_taisyo.py " # 実行されるプログラム
common.columns=['dataset','seed','id','NN','Nh','alpha_i','alpha_r','alpha_b','alpha_s','beta_i','beta_r','beta_b',
'Temp','lambda0',"delay","degree","MC","set",'cnt_overflow',"per"]
common.parallel= 32
common.setup()
