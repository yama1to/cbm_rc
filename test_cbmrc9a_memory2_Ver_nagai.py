...
### 共通設定
from cbmrc9a_memory2 import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc9a_memory2_Ver_nagai" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc9a_memory2_Ver_nagai" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc9a_memory2_Ver_nagai.py " # 実行されるプログラム
common.columns=['dataset','seed','id','NN','Nh','alpha_i','alpha_r','alpha_b','alpha_s','beta_i','beta_r','beta_b',"alpha0","alpha1",
...
def optimize():
    ...
    opt.append("alpha1",value=1,min=0,max=1,round=2)
...
def gs2():
    ...
    gridsearch("alpha1",min=0.,max=1,num=41,samples=ns)
