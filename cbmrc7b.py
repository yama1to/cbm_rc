...
def output():
    ...
    % (seed,id,NN,Nh,alpha_i,alpha_r,alpha_b,alpha0,alpha1,alpha2,beta_i,beta_r,beta_b,Temp,lambda0,RMSE[0],RMSE[1],RMSE[2],count_gap)
    #print(str)
    filename= 'data_cbmrc7b_' + ex + '.csv'
    f=open(filename,"a")
    f.write(str)
    f.close()
