...
def execute():
    ...
    ### generate data
    if c.dataset==1:
        U1,U2,D1,D2 = generate_coch(shuffle = 0)

    dataset_num =250

    U1 = U1[:dataset_num*312] * 10**4
    U2 = U2[:dataset_num*312] * 10**4
    D1 = D1[:dataset_num*312]
    D2 = D2[:dataset_num*312]
    ...
    Y_pred = fy(Wout.T @ collect_state_matrix[c.MM0:].T)
