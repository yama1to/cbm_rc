...
### 共通設定
from cbmrc9a_memory2_linear2 import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc9a_memory2_linear2" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc9a_memory2_linear2" % common.string_now() # 実験データを出力するディレクトリのパス
...
def gs2():
    ...
    #gridsearch("alpha1",min=1,max=40,num=41,samples=ns)
