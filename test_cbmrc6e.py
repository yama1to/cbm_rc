...
### 共通設定
from cbmrc6f import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc6e" % common.string_today() # 実験名（ファイルの接頭辞）
common.dir_path= "data%s_cbmrc6e" % common.string_today() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc6e.py " # 実行されるプログラム
common.columns=['dataset','seed','id','NN','Nh','alpha_i','alpha_r','alpha_b','alpha_s','alpha0','alpha1','beta_i','beta_r','beta_b','Temp','lambda0','RMSE1','RMSE2','count_gap']
...
### １変数グリッドサーチ
def gs1():
    gs.scan1d("alpha_r",min=0,max=5,num=21)
