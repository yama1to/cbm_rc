...
opt.parallel=40
opt.exe="python cbmrc7c.py display=0 ex=opt1"
opt.filename_tmp="data_cbmrc7c_opt1.csv"
opt.filename_rec="data_cbmrc7c_opt1_rec.csv"
...
opt.config()
opt.names=['seed','id','NN','Nh','alpha_i','alpha_r','alpha_b','alpha_s','alpha0','alpha1','beta_i','beta_r','beta_b','Temp','lambda0','RMSE0','RMSE1','RMSE2','count_gap']

def func(row):
    #return row['RMSE1'] + 0.1*row['count_gap']
    return row['RMSE0']+row['RMSE2']+0.1*row['count_gap']
...
id=0
exe="python cbmrc7c.py display=0 "
