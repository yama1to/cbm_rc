...
### 共通設定
from esn_narma3 import Config
config = Config()
common.config  = config
common.prefix  = "data%s_esn_narma3" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_esn_narma3" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python esn_narma3.py " # 実行されるプログラム
