...
### 共通設定
from cbmrc9a_memory2_try import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc9a_memory2_try" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc9a_memory2_try" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc9a_memory2_try.py " # 実行されるプログラム
...
def gs2():
    ...
    gridsearch("Temp",min=0,max=256,num=41,samples=ns)
