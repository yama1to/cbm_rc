...
### 共通設定
from cbmrc9a_memory2_rs import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc9a_memory2_rs" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc9a_memory2_rs" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python cbmrc9a_memory2_rs.py " # 実行されるプログラム
...
def gs22():
    x1,x2 = "Nh","NN"
    gs.scan2d(x1,x2,min1=20,max1=1000,min2=2**7,max2=2**10,samples=3,num1=11,num2=11)
    vs.plot2d(x1,x2,"MC")
