...
### 共通設定
from esn_speech3 import Config

config = Config()
common.config  = config
common.prefix  = "data%s_esn_speech3" % common.string_now() # 実験名（ファイルの接頭辞）
...
def optimize():
    ...
    opt.minimize(target="WER",iteration=20,population=10,samples=3)
